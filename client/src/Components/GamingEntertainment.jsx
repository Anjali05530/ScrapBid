...
const GamingEntertainment = () => {
    ...
    const GamingEntertainmentProducts = auctionData.filter(
        (item) => item.category?.trim().toLowerCase() === "gaming entertainment"
    );
    ...
    return (
        <div style={{ padding: "20px", maxWidth: "1200px", margin: "auto" }}>
            ...
            >
                {GamingEntertainmentProducts.length > 0 ? (
                    GamingEntertainmentProducts.map((item) => (
                        <div 
                            key={item.id} 
